...
header("Content-Disposition: attachment; filename=".date('Y_m_d', time())."_export_market_de.csv");
...
from ddfa_main_domain_model_location as l, ddfa_main_domain_model_marketentry as i
where l.market_entry_id = i.persistence_object_identifier and i.locale = 'de' and l.locale = 'de' and l.type = '3'

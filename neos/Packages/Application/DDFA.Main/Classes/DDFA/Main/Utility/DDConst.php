...
abstract class DDConst
{
    ...
    const ME_SUPPLEMENT_PROPS = ["offer", "dateFrom", "dateTo", "timeFrom", "timeTo", "area", "name", "description", "descriptionShort", "mail", "web", "facebook", "phone", "subCategory", "speakerPublic", "speakerPrivate", "image", "imageType", "supportWanted", "category", "spokenLanguages", "forChildren","certified"];

...
abstract class DDConst
{
    ...
    const ME_SUPPLEMENT_PROPS = ["offer", "dateFrom", "dateTo", "timeFrom", "timeTo", "area", "name", "description", "mail", "web", "facebook", "phone", "speakerPublic", "speakerPrivate", "image", "imageType", "supportWanted", "category", "spokenLanguages", "forChildren"];
